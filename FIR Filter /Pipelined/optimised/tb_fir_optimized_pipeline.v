// ============================================================
// Testbench: fir_optimized_pipeline
// ============================================================

`timescale 1ns/1ps

module tb_fir_optimized_pipeline;
    ...
    initial begin
        ...
        // Impulse test
        $display("=== Impulse Response Test (Optimized Pipeline) ===");
        ...
        fout_950  = $fopen("vout_optimized_950.txt",  "w");
        fout_1100 = $fopen("vout_optimized_1100.txt", "w");
        fout_2000 = $fopen("vout_optimized_2000.txt", "w");
